...
//
//------------------------------------------------------------------------
void VL60pk::stepBrakesEquipment(const double& t, const double& dt)
{
    ...
    brake_mech[TROLLEY_FWD]->setBCflow(bc_pressure_relay->getPipeFlow());
    ...
    brake_mech[TROLLEY_BWD]->setBCflow(bc_switch_valve->getOutputFlow());
