...
void VL60k::debugPrint(double t, double dt)
{
    ...
    DebugMsg += QString("pTM %1 MPa | pBC %2 MPa | pSR %3 MPa | ")
            .arg(brakepipe->getPressure(), 6, 'f', 3)
            .arg(brake_mech[TROLLEY_FWD]->getBCpressure(), 6, 'f', 3)
            .arg(supply_reservoir->getPressure(), 6, 'f', 3);
