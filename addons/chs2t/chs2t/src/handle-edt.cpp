...
//
//------------------------------------------------------------------------------
void HandleEDT::setPipiLinePressure(double press)
{
    pFL = press;
}
...
//
//------------------------------------------------------------------------------
void HandleEDT::setBrefPressure(double press)
{
    p_bref = press;
}
...
//
//------------------------------------------------------------------------------
void HandleEDT::setBrakeKey(int key)
{
    brakeKey = key;
}
...
//
//------------------------------------------------------------------------------
void HandleEDT::setReleaseKey(int key)
{
    releaseKey = key;
}
...
//
//------------------------------------------------------------------------------
float HandleEDT::getHandlePos() const
{
...
//
//------------------------------------------------------------------------------
double HandleEDT::getQ_bref() const
{
    return Q_bref;
}
