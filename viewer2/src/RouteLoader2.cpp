...
RouteLoader2::RouteLoader2(const std::string& route_path)
    : route_path(route_path)
{
}

void RouteLoader2::read_description()
{
...
bool RouteLoader2::parse_objects_ref(Route& route)
{
...
bool RouteLoader2::parse_route_map(Route& route)
{
