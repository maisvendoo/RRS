...
Для организации движения попутных и встречных поездов в сценарии (кроме поездов игроков), предсмотрен режим автоматического управления движением. Все поезда сценария поделируются физически, и соответственно, для формирования встречных и попутных поездов используются те же принципы, что и для создания поезда игрока. Поезда можно формировать из всего представленного в игре подвижного состава.
