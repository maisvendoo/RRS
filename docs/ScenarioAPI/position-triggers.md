...
Для облегчения решения этой задачи предусмотрена специальная триггерная функция, обеспечивающая автоматическое построение поездных маршрутов в заданном направлении. Эта функция описана в [приложении 3](appendix3.md), и называется она setAutoApproachTrigger().
