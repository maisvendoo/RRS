...
Теперь, при освобождении стрелочного участка маршрут не будет строится маршрут пропуска, а будет установлен триггер, который сработает при занятии поездом три второго участка приближения и построит ему маршрут.