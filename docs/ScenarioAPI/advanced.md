...
Соотвественно, логика работы нашей action-функций может быть произвольной. К сожалению, для полного овладения всеми возможностями, которые предоставляет данный механизм, придуться погрузиться в изучение языка Lua. Но некоторые вещи мы все же разберем здесь.
