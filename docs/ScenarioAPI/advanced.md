...
Рассмотрим такую задачку - поставить временно́й тригер на построение сквозного пропуска в двух направлениях для произвольной станции. Причём action-функция будет одна единственная, а триггеров мы поставим два - один для станции B, другой для станции C.
