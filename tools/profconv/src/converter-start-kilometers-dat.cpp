                                   ...
                                   zds_start_km_data_t &waypoints)
{
    while (!stream.atEnd())
    {
        ...
        waypoint.forward_trajectory_coord = tracks_data2[waypoint.forward_track_id].trajectory_coord;
        waypoint.forward_railway_coord = tracks_data2[waypoint.forward_track_id].railway_coord;
