...
public:
    ...
    /// Включить/выключить вводной аппарат локомотива (после появления / напряжения - шаг 8 последовательности игрока)
    ...
    /// Движение запрещено (кабель ещё подключён - потребитель / обрежет тягу)
