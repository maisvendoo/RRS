...
//
//      Источник погоды будет подключён системой погоды; сейчас состояние задаётся API/сценарием.
//
//------------------------------------------------------------------------------
...
public:
    ...
    /// Множитель коэффициента сцепления для оси (оси различаются).
    ...
    /// Подать песок под ось: локальный временный рост сцепления
