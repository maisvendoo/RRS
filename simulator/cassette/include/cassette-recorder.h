...
//      краше данные до последнего сброса сохраняются.
//
//      Все значения поступают из реальных физических систем через
//      CassetteFrame (модель их заполняет).
//
//------------------------------------------------------------------------------
...
struct CassetteFrame
{
    ...
    double equalizing_reservoir_pressure = 0.0; ///< кгс/см2 (УР)
    ...
    // Дискретные каналы (битовая маска)
