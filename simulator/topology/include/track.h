...
struct TOPOLOGY_EXPORT track_t
{
    ...
    /// Возвышение наружного рельса в начале трека, мм (Б16:
    /// "Поперечная динамика" п.14-15; свойство ПУТИ из [Cant] конфига
    /// маршрута, по умолчанию 0). Знак: "+" - левый рельс выше.
    /// Интерполируется линейно к значению следующего трека -
    /// это отвод возвышения
    double cant_mm = 0.0;
