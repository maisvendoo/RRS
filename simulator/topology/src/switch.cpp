...
//
//------------------------------------------------------------------------------
void Switch::setSignalFwd(Signal *signal)
{
...
//
//------------------------------------------------------------------------------
const Signal* Switch::getSignalFwd() const
{
    return signal_fwd;
}
...
//
//------------------------------------------------------------------------------
void Switch::setSignalBwd(Signal *signal)
{
...
//
//------------------------------------------------------------------------------
const Signal* Switch::getSignalBwd() const
{
    return signal_bwd;
}
...
//
//------------------------------------------------------------------------------
Switch_state_t Switch::getStateFwd() const
{
    return state_fwd;
}
...
//
//------------------------------------------------------------------------------
Switch_state_t Switch::getStateBwd() const
{
    return state_bwd;
}
...
//
//------------------------------------------------------------------------------
Switch_state_t Switch::getRefStateFwd() const
{
    return ref_state_fwd;
}

//------------------------------------------------------------------------------
//
//------------------------------------------------------------------------------
Switch_state_t Switch::getRefStateBwd() const
{
    return ref_state_bwd;
}

//------------------------------------------------------------------------------
//
//------------------------------------------------------------------------------
Signal* Switch::getRouteBySignalFwd() const
{
...
//
//------------------------------------------------------------------------------
void Switch::setRouteBySignalFwd(Signal* signal)
{
...
//
//------------------------------------------------------------------------------
Signal* Switch::getRouteBySignalBwd() const
{
...
//
//------------------------------------------------------------------------------
void Switch::setRouteBySignalBwd(Signal* signal)
{
