...
//      одинакова на всех клиентах и при повторных проездах.
//
//------------------------------------------------------------------------------
...
public:
    ...
    /// Детерминировано, возбуждает поперечную динамику ПС (/// "Поперечная динамика")
    ...
    /// Накопление тоннажа по участкам (износ рельсов).
...
struct TRACKPROFILE_EXPORT TrackProfileConfig
{
    ...
    /// Автогенерация неровностей на стрелочных переводах (крестовина: / двойной импульс + жёсткий удар)
