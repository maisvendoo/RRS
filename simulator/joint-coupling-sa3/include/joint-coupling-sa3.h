...
private:
    ...
    /// Непустая - заменяет piece-wise модель
    ...
    /// Тип сцепного устройства (совместимость сцепок, coupling):
    ...
    /// Накопление повреждений и проверка разрушения (не разрушать сразу, коэффициент повреждения)
