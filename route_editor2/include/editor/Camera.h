...
public:
     ...
     *
     * Create perspective and orthographic projection matrices, as well as a
     * LookAt view matrix, based on the camera_settings and window_extent
     * parameters. Then set the projection matrix to perspective mode.
     *
