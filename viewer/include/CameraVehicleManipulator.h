...
class CameraVehicleManipulator final : public CameraAbstract
{
public:
...
private:
    ...
    double _last_angle_right = vsg::radians(-45.0);
    double _last_angle_up = -vsg::radians(10.0);
    double _last_distance = 20.0;
};
