...
public:
    ...
    /// Дальность видимости по погоде, м (ТЗ "Видимость и погода")
...
private:
    ...
    /// Погода от симулятора (ТЗ "Видимость и погода"): пишется сетевым
    ...
    /// Диагностика составов (ТЗ F3/F4): двойной буфер
