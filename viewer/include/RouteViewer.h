...
private:
    ...
    /// пресета и применение QualityParams к настройкам рендера
...
private:
    ...
    /// Динамический свет фар (High+): создаётся в
    ...
    /// Динамический свет/частицы «запекаются» при старте:
